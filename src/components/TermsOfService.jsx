      ...
      <div className="tos-view">
        <div className="close-btnBox">
          <div className="close-btn" onClick={close}>
            <span className="close-button icon-close"></span> Close
          </div>
        </div>
        <div className="terms-body">
          ...
          <div className="tos-labels">
            <p>
              I am a salesperson or sales manager employed by the dealership
              whose OEM dealer code I have entered herein.
            </p>
            <p>
              I am authorized to perform this lookup by my dealership
              management.
            </p>
            <p>
              I have explicit consent from the customer whose name I have
              entered to initiate the process of asserting whether they are
              currently eligible for a private offer from the OEM whose brand my
            ...
            <p>
              Usage of this system is monitored and audited. All data provided
              is recorded for security and verification purposes.
            </p>
          </div>
        </div>
      </div>
